...
Frame.BackgroundColor3 = Color3.new(0.219608, 0.219608, 0.219608)
...
ImageLabel.ImageColor3 = Color3.new(0.392157, 0.392157, 0.392157)
ImageLabel.ScaleType = Enum.ScaleType.Crop

TextButton.Parent = ImageLabel
TextButton.BackgroundColor3 = Color3.new(0.247059, 0.247059, 0.247059)
...
Shadow.ImageColor3 = Color3.new(0.694118, 0.694118, 0.694118)
...
Shadow_2.ImageTransparency = 0.5
...
Shadow_3.ImageTransparency = 0.5
...
FPS.BorderColor3 = Color3.new(0.105882, 0.164706, 0.207843)
...
Frame_2.BackgroundColor3 = Color3.new(0.996078, 0.368627, 0.337255)
...
Frame_3.BackgroundColor3 = Color3.new(1, 0.741176, 0.180392)
...
Sensor_2.BackgroundTransparency = 1
...
Frame_4.BackgroundColor3 = Color3.new(0.152941, 0.784314, 0.247059)
...
Sensor_3.BackgroundTransparency = 1
...
TextLabel2.BackgroundColor3 = Color3.new(0.196078, 0.196078, 0.196078)
...
ImageLabel_3.ImageColor3 = Color3.new(0.392157, 0.392157, 0.392157)
ImageLabel_3.ScaleType = Enum.ScaleType.Crop

TextButton_2.Parent = ImageLabel_3
TextButton_2.BackgroundColor3 = Color3.new(0.247059, 0.247059, 0.247059)
...
Shadow_4.ImageColor3 = Color3.new(0.694118, 0.694118, 0.694118)
Shadow_4.ImageTransparency = 0.5
...
Shadow_5.ImageTransparency = 0.5
...
Shadow_7.ImageColor3 = Color3.new(0.694118, 0.694118, 0.694118)
Shadow_7.ImageTransparency = 0.5
...
FPS_2.Name = "FPS"
FPS_2.Parent = main
FPS_2.BackgroundColor3 = Color3.new(1, 1, 1)
FPS_2.BackgroundTransparency = 1
FPS_2.BorderColor3 = Color3.new(0.105882, 0.164706, 0.207843)
...
FPS_2.Text = "FPS:"
FPS_2.TextColor3 = Color3.new(1, 1, 1)
...
Container_5.BackgroundTransparency = 1
...
Container_6.BackgroundTransparency = 1
...
Frame_5.BackgroundColor3 = Color3.new(0.996078, 0.368627, 0.337255)
...
Sensor_4.BackgroundTransparency = 1
...
Container_7.BackgroundTransparency = 1
...
Frame_6.BackgroundColor3 = Color3.new(1, 0.741176, 0.180392)
...
Sensor_5.BackgroundTransparency = 1
...
Container_8.BackgroundTransparency = 1
...
Frame_7.BackgroundColor3 = Color3.new(0.152941, 0.784314, 0.247059)
...
Sensor_6.BackgroundTransparency = 1
...
local function VXJXL_fake_script() -- TextButton.LocalScript 
	...
	parent.MouseButton1Click:Connect(function() 
		...
		wait(0.2)
		parent.Parent.Parent.Parent.main.Visible = true
		script.Parent.Parent.Parent.Visible=false
	end)
end
coroutine.wrap(VXJXL_fake_script)()
local function CTWCZUZ_fake_script() -- Frame.FPSTracker 
...
coroutine.wrap(CTWCZUZ_fake_script)()
local function TSJVDHJ_fake_script() -- TextLabel2.LocalScript 
...
coroutine.wrap(TSJVDHJ_fake_script)()
local function IICVTRI_fake_script() -- Frame.DragScript 
...
coroutine.wrap(IICVTRI_fake_script)()
local function MFMZY_fake_script() -- TextButton_2.LocalScript 
	...
	parent.MouseButton1Click:Connect(function() 
		...
		-- action
		parent.Visible = false
		loadstring(game:HttpGet("https://raw.githubusercontent.com/yinyangbalance/SolaraScripts/main/forsilent.luau"))() 
	end)
end
coroutine.wrap(MFMZY_fake_script)()
local function EJWZ_fake_script() -- TextButton_3.LocalScript 
...
coroutine.wrap(EJWZ_fake_script)()
local function EDOP_fake_script() -- main.FPSTracker 
...
coroutine.wrap(EDOP_fake_script)()
local function WKOL_fake_script() -- main.DragScript 
...
coroutine.wrap(WKOL_fake_script)()
